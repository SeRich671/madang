@extends('layouts.admin', ['menuName' => 'Tworzenie adresu dla użytkownika ' . $user->first_name . ' ' . $user->last_name])

@section('content')
    <form method="POST" action="{{ route('admin.user.address.store', $user) }}">
        @csrf
        <div class="row mb-3">
            <div class="col-lg-12">
                @if(session('error'))
        ...
        <div class="row mb-3">
            ...
            <div class="col-lg-6">
                <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="street" value="{{ old('address') }}" required autocomplete="address">
        ...
        <div class="row mb-3">
            ...
            <div class="col-lg-6">
                <input id="zipcode" type="text" class="form-control @error('zipcode') is-invalid @enderror" name="zip_code" value="{{ old('zipcode') }}" required autocomplete="zipcode">
