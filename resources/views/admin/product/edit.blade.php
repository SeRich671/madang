        ...
        <div class="row mb-3">
            <div class="col-lg-6 offset-lg-4">
                <div class="form-check">
                    ...
                    <input type="checkbox" value="1" name="sticker" id="sticker" class="form-check-input" @checked($product->sticker)>
            ...
            <div class="col-lg-4">
                <select id="stickers" class="form-control" name="stickers[]" multiple>
                    @foreach($stickers as $key => $sticker)
                        <option value="{{ $key }}" @selected(in_array($key, $product->stickers->pluck('id')->toArray()))>
                            {{ $sticker }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="row mb-3">
            <div class="col-lg-6 offset-lg-4">
                <div class="form-check">
                    ...
                    <input type="checkbox" value="1" name="later_delivery" id="later_delivery" class="form-check-input" @checked($product->later_delivery)>
